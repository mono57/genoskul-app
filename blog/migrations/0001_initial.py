    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, verbose_name='Titre de Fact')),
                ('slug', models.SlugField()),
                ('content', tinymce_4.fields.TinyMCEModelField(verbose_name='Contenu')),
                ('image', models.ImageField(blank=True, null=True, upload_to='posts/', verbose_name='Image de couverture')),
                ('categories', models.ManyToManyField(related_name='posts', to='blog.PostCategory', verbose_name='Categorie')),
